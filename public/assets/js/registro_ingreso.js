document.addEventListener('DOMContentLoaded', function () {
    ...
    // Función compartida para validación
    ...
    // Evento para escáner automático (código)
    document.getElementById('codigo').addEventListener('input', function(event) {
        validarCodigo(this);
    });

    // Evento para tecla Enter (código2)
    ...
    // Evento para el botón de verificación (código2)
    btnVerificarCodigo.addEventListener('click', function() {
        const codigoInput = document.getElementById('codigo2');
        validarCodigo(codigoInput, true); // true para usar SweetAlert
    });
    // ==============================================
    // MANEJO DE MODALES
    // ==============================================
    ...
    btnRegistrarNuevoPC.className = 'btn btn-success flex-grow-1'; // Clase modificada
