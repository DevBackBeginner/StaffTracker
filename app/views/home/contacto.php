...
<html class="wide wow-animation" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/ControlAsistencia/public/assets/css/contacto.css">
    </head>
    <body>
        <div class="ie-panel">
            <a href="http://windows.microsoft.com/en-US/internet-explorer/">
                <img src="/ControlAsistencia/public/assets/img/sena1.jpg" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today.">
            </a>
        </div>
        <div class="preloader">
