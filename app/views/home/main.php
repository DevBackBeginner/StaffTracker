    ...
    <div class="page">
      <div id="home">
        ...
        <section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="true" data-autoplay="4859" data-simulate-touch="true" data-direction="vertical" data-nav="false">
            ...
            <div class="swiper-slide" data-slide-bg="/ControlAsistencia/public/assets/img/sena1.jpg">
            ...
            <div class="swiper-slide" data-slide-bg="/ControlAsistencia/public/assets/img/sena2.jpg">
            <div class="swiper-slide-caption section-md">
            <div class="container">
            ...
            <div class="swiper-slide" data-slide-bg="/ControlAsistencia/public/assets/img/sena3.jpg">
            <div class="swiper-slide-caption section-md">
            <div class="container">
      ...
      <section class="section section-sm section-first bg-default text-center" id="services">
        <div class="container">
          <div class="row row-30 justify-content-center">
            <div class="col-md-7 col-lg-5 col-xl-6 text-lg-left wow fadeInUp"><img src="/ControlAsistencia/public/assets/img/seguridad.jpg" alt="" width="1000" height="592"/>
            </div>
              ...
              <div class="row row-30">
                ...
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".1s">
                  <article class="box-icon-modern box-icon-modern-2">
                    ...
                    <h5 class="box-icon-modern-title"><a href="#">REGISTRO AUTOMÁTICO</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text" style="color: #00304D;">El escaneo del carné permite registrar automáticamente la entrada y salida del personal.</p>
                  </article>
                </div>
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".2s">
                  <article class="box-icon-modern box-icon-modern-2">
                    <div class="box-icon-modern-icon linearicons-headset"></div>
                    <h5 class="box-icon-modern-title"><a href="#">CONTROL DE VISITAS</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text" style="color: #00304D;">Los visitantes registran sus datos y motivo de ingreso de manera rápida y eficiente.</p>
                  </article>
                </div>
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".3s">
                  <article class="box-icon-modern box-icon-modern-2">
                    <div class="box-icon-modern-icon linearicons-outbox"></div>
                    <h5 class="box-icon-modern-title"><a href="#">INFORMES Y SEGUIMIENTO</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text" style="color: #00304D;">Genera reportes detallados sobre el flujo de personas dentro de las instalaciones.</p>
                  </article>
                </div>
              </div>
            </div>
...
<section class="section section-fluid bg-default">
    <div class="parallax-container" data-parallax-img="/ControlAsistencia/public/assets/img/sena4.jpg">
        <div class="parallax-content section-xl context-dark bg-overlay-68 bg-mobile-overlay">
            <div class="container">
                <div class="row row-30 justify-content-end text-right">
                    <div class="col-sm-7">
                        <h3 class="wow fadeInLeft" style="color: white; text-shadow: 2px 2px 4px #007832;">Gestión de Accesos Eficiente</h3>
                        <p style="color: white; text-shadow: 2px 2px 4px #007832;">Con nuestro sistema de control de acceso, garantizamos una entrada y salida rápida y segura para instructores, directivos, administrativos y visitantes. Optimiza la gestión y mejora la seguridad en las instalaciones del SENA.</p>
                        <div class="group-sm group-middle group justify-content-end"></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="container">
    <div class="row row-30 row-xl-24 justify-content-center align-items-center align-items-lg-start text-left">
      <div class="col-md-6 col-lg-5 col-xl-4 text-center"><a class="text-img" href="#">
          ...
          <span class="counter">100<span class="percentage">%</span></span>
      </a></div>
  ...
  <div class="container">
    <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
      <div class="col-lg-6 col-xl-5 wow fadeInLeft">
        <h2>Características Clave de Nuestro Sistema</h2>
        <!-- Bootstrap tabs-->
        <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big text-center text-md-left" id="tabs-6">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="tabs-6-1">
              <h5 class="font-weight-normal">Registro de Ingreso por Carné</h5>
            <p style="color: #00304D;">El sistema permite registrar automáticamente la entrada de instructores y personal autorizado mediante el escaneo de su carné, capturando datos precisos como la fecha y hora de ingreso.</p>
              <div class="group-sm group-middle"></div>
            </div>
            <div class="tab-pane fade" id="tabs-6-2">
              <h5 class="font-weight-normal">Registro de Visitantes</h5>
            <p style="color: #00304D;">Los visitantes podrán registrar su ingreso completando un formulario con sus datos personales y el motivo de su visita, asegurando un control eficiente del acceso a las instalaciones.</p>
              <div class="group-sm group-middle"></div>
            </div>
            <div class="tab-pane fade" id="tabs-6-3">
              <h5 class="font-weight-normal">Seguridad y Control</h5>
            <p style="color: #00304D;">Gracias al registro detallado de entradas y salidas, nuestro sistema mejora la seguridad en las instalaciones del SENA, permitiendo tener un historial completo de los accesos.</p>
              <div class="group-sm group-middle"></div>
            </div>
            <div class="tab-pane fade" id="tabs-6-4">
              <h5 class="font-weight-normal">Optimización de la Administración de Accesos</h5>
            <p style="color: #00304D;">El sistema facilita la gestión de los accesos, permitiendo una administración más eficiente de los recursos humanos y un mejor control sobre el personal de seguridad y guardias.</p>
              <div class="group-sm group-middle"></div>
            </div>
          </div>
        </div>
    ...
    <div class="row row-sm row-30 justify-content-center">
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight">
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="/ControlAsistencia/public/assets/img/instructor.jpg" alt="" width="420" height="424"/></a>
          ...
          <h4 class="team-classic-name"><a href="#" style="color: white; text-shadow: 2px 2px 4px #007832;">Instructores</a></h4>
            <p class="team-classic-status">Registro de entrada y salida de instructores para asegurar el control de acceso.</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".1s">
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="/ControlAsistencia/public/assets/img/directivos.jpg" alt="" width="420" height="424"/></a>
          <div class="team-classic-caption">
          <h4 class="team-classic-name"><a href="#" style="color: white; text-shadow: 2px 2px 4px #007832;">Administrativos</a></h4>
            <p class="team-classic-status">Control de ingreso de personal administrativo para mantener la seguridad en las instalaciones.</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".2s">
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="/ControlAsistencia/public/assets/img/visitantesena.jpg" alt="" width="420" height="424"/></a>
          <div class="team-classic-caption">
            <h4 class="team-classic-name"><a href="#" style="color: white; text-shadow: 2px 2px 4px #007832;">Visitantes</a></h4>
            <p class="team-classic-status">Registro de visitantes, incluyendo motivo de visita y datos personales para garantizar el acceso adecuado.</p>
          </div>
        </article>
      </div>
    </div>
