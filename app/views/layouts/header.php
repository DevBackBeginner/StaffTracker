...
<html lang="en">
   <head>
      ...
      <link href="/ControlAsistencia/public/assets/img/logo.png" rel="apple-touch-icon">
      ...
      <div class="header">
         <div class="container-fluid">
            <div class="row align-items-center">
               <div class="col-12 col-md-3 logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="Inicio"><img src="/ControlAsistencia/public/assets/img/logo.png" alt="#" class="img-fluid" /></a>
                        </div>
                     </div>
                  </div>
               </div>
