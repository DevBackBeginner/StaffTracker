<footer class="d-flex flex-column" style="border: 1px solid green; box-shadow: 0 4px 8px rgba(0, 128, 0, 0.5); padding: 20px; border-radius: 10px; margin-top: 50px;">
    <div class="containers p-3 mb-auto"> 
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase" style="font-size: 1rem;">Control de Acceso</h5>
                <ul class="list-unstyled" style="font-size: 0.85rem;">
                    <li><a href="#" class="text-dark">Procedimiento de Ingreso y Salida</a></li>
                    <li><a href="#" class="text-dark">Normas de Seguridad</a></li>
                    <li><a href="#" class="text-dark">Registro de Incidencias</a></li>
                    <li><a href="#" class="text-dark">Manual de Usuario del Sistema</a></li>
                </ul>
            </div>
        </div>
    </div>
