<?php 
    include_once __DIR__ . '/../../views/gestion/dashboard/layouts/header_main.php'; 
            ...
            <div class="col-xl-4">
                <div class="card">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    html: `<?= str_replace(["'", "\n"], ["\'", "<br>"], htmlspecialchars($_SESSION['mensaje'], ENT_QUOTES)) ?>`,
                                    icon: '<?= $_SESSION['tipo_mensaje'] === 'error' ? 'error' : 'success' ?>',
                                    confirmButtonText: 'Aceptar',
                                    confirmButtonColor: '#007832',
                                    allowOutsideClick: false,
                                    customClass: {
                                        popup: 'animated bounceIn' // Animación opcional
                                    }
                                });
                            });
                        </script>
                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h3><?= ($_SESSION['usuario']['rol'] === 'Administrador') ? 'Administrador' : (htmlspecialchars($_SESSION['usuario']['rol']) === 'Guarda' ? 'Guardia de portería' : htmlspecialchars($_SESSION['usuario']['rol'])) ?></h3>
                    </div>
                </div>
            </div>
            <style>
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 text-muted"><?= htmlspecialchars($_SESSION['usuario']['nombre'] . ' ' . $_SESSION['usuario']['apellido']) ?></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 text-muted"><?= ($_SESSION['usuario']['rol'] === 'Administrador') ? 'Coordinador' : htmlspecialchars($_SESSION['usuario']['rol']) ?></div>
                                </div>
                                <div class="row">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                <form method="POST" action="actualizar" enctype="multipart/form-data" class="container mt-4 p-4 border rounded shadow-sm bg-light">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="apellidos" type="text" class="form-control" id="apellidos" value="<?= htmlspecialchars($_SESSION['usuario']['apellido'] ?? '') ?>" required>
                                    </div>
